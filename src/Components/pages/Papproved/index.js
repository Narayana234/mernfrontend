       ...
       if(isclicked){
        return(
            ...
            flexDirection:"column",color:"black",justifyContent:"center",alignItems:"center"}}>
                ...
                <button type="submit"   style={{marginTop:"20px",backgroundColor:"red",marginLeft:"40px",border:"0px",color:"white",padding:"5px",borderRadius:"5px"}} onClick = {this.payed}> Confirm Payment</button>
                </div>
        ...
        return(
            ...
            flexDirection:"column",color:"black",justifyContent:"center",alignItems:"center"}}>
                <div style={{border:"2px solid yellow",marginBottom:"50px",padding:"10px"}}>
                   <img src = "./images/paymet.png" style={{width:"40px"}}/>
                <p style={{color:"black"}}> Doctor Name : {obj.dname}</p>
                <p style={{color:"black"}}> Doctor Fees : {obj.doctorFees}</p>
                <p style={{color:"black"}}> date : {obj.bookeddate}</p>
                <p style={{color:"black"}}> time : {obj.bookedtime}</p>
                <button type="submit"   style={{marginTop:"20px",marginLeft:"40px",backgroundColor:"red",border:"0px",color:"white",padding:"5px",borderRadius:"5px"}} onClick = {()=>(window.print())}>Print</button>
                </div>
